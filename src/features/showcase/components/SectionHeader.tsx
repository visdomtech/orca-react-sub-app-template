...
/**
 * Section opener for the showcase page: colored icon chip + title + description.
 * The chip tint is derived from theme tokens via alpha() - never raw hex.
 */
export function SectionHeader({ icon, title, description, color = "primary" }: SectionHeaderProps) {
  return (
